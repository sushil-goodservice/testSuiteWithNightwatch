...
module.exports = {
  ...
  'Signup': function (browser) {
    ...
    browser.waitForElementPresent('body', 2000);
     browser.setValue('input[type=email]', '');
    browser.setValue('input[type=password]', 'goodservice');
    browser.click('input[type=submit]');
    browser.saveScreenshot('./screenshots/error2.png');
    browser.waitForElementPresent('body', 2000);
    //browser.assert.urlEquals(browser.launch_url + '/user/sign_in?is_recruiter=&redirecturl=');
    browser.saveScreenshot('./screenshots/already-register-validation.png');
    ...
    browser.saveScreenshot('./screenshots/candidate-login-if-exist.png');
