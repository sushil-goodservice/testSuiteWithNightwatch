...
module.exports = {
  ...
  'Recruiter forgot Password if Exist': function (browser) {
    ...
    function recruiterSignupFormFunction(recruiterSingupFormElements){
      ...
      browser.useCss().setValue(recruiterSingupFormElements[2].selector, 'Rahul');
      browser.useCss().clearValue(recruiterSingupFormElements[3].selector);
      browser.useCss().setValue(recruiterSingupFormElements[3].selector, 'Goodservice');
    ...
    browser.pause(2000);
    browser.assert.urlContains(browser.launch_url + '/user/sign_in?is_recruiter=true');
